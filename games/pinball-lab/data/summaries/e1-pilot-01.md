...
> ⚠ **STALE — RULING: exempt by declared premise, not retracted.** Produced on pre-fix solver commit `9a6eb1e7fd21f657170a831edc07416585391058` (before the e5ff0d7 kinematic-flipper solver fix). Regeneration at HEAD was attempted and refused: `{"ok":false,"error":"§2.7 gate: flagged fraction 11.56% exceeds 1%","out":"data/e1/pilot-01-20260904"}` — this is a gate-scope problem, not a corpus defect: the cause (TIMEOUT from §3.3's slow-speed sampling against the 2.0s cap) is already documented in this summary's own per-cfg warnings, and the solver-validity flag the gate exists to protect against, `IMPACTS_EXHAUSTED`, is 0.650% post-fix — under the gate. Do not retire, do not redesign, do not loosen the gate. Ruling: `ledger/handoffs/opus2/20260904T150000Z-three-gate-rulings.md` §(b).
