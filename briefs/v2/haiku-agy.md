...
1. **Your handoffs go to `/Users/pup/fleet/ledger/handoffs/haiku-agy2/` — that absolute
...
3. **Never report a process as agy's unless you established it.** Not from `ps`
   showing a process with a familiar name; not from inference. If you say agy is
